...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-smartdrone-secret-key-change-in-production'
)
...
# Allow all origins for the mobile app (tighten in production)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shop.context_processors.ui_settings',
            ],
        },
    },
]
